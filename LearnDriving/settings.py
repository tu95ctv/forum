...
DATABASES = {
    'default': {
        ...
        'NAME': 'upload2',                      # Or path to database file if using sqlite3.
...
DATABASES = {
    ...
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'daks032kbojc74',                      # Or path to database file if using sqlite3.
        
        
        'USER': 'tkmimeraggnjin',                      # Not used with sqlite3.
        'PASSWORD': 'T3RjiHlpgqCbO06fkTFzvYgDCi',                  # Not used with sqlite3.
        'HOST': 'ec2-54-243-203-104.compute-1.amazonaws.com',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '5432',                      # Set to empty string for default. Not used with sqlite3.
    }
}
'''
